...
LLVMUNWIND_OPTS := $(CMAKE_COMMON) -DCMAKE_BUILD_TYPE=MinSizeRel -DLIBUNWIND_ENABLE_PEDANTIC=OFF -DLLVM_PATH=$(SRCCACHE)/$(LLVM_SRC_DIR)/llvm -DLLVM_CONFIG_PATH=$(build_depsbindir)/llvm-config
